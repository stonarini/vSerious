...
#define SYMBOLIC_LINK_NAME_PREFIX_LEN  (sizeof(SYMBOLIC_LINK_NAME_PREFIX) - sizeof(WCHAR))
...
typedef struct _CONTROLLER_CONTEXT
{
    ...
    WCHAR           SymbolicLinkBuffer[SYMBOLIC_LINK_NAME_LENGTH / sizeof(WCHAR)];

    WDFWORKITEM     PlugInWorkItem;
